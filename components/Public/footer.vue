<template>
  <footer class="font-sans tracking-wide bg-gray-800 px-8 py-12">
    <UContainer>
      <div
        class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-6 gap-y-10"
      >
        <div>
          <a href="javascript:void(0)"
            ><img src="/logo.png" alt="logo" class="w-44"
          /></a>
        ...
        <div>
          <h4
            class="text-white font-semibold text-lg relative max-sm:cursor-pointer"
          >
            Services
            <svg
              xmlns="http://www.w3.org/2000/svg"
